...
### Added
- **Per-engine install and per-engine result.** Each missing engine gets its own button; one failing never blocks the other, or a scan with the engine you do have.
