...
if [ -f "extension.js" ] && [ -f "sidebarProvider.js" ]; then
...
if node -c extension.js && node -c sidebarProvider.js; then
...
# Test 4: Test Docker image availability
...
# Test 5: Test the scan functionality with a simple test
